...
public class XRefreshViewHeader extends LinearLayout implements IHeaderCallBack {
    ...
    private void initView(Context context) {
        ...
        if (android.os.Build.VERSION.SDK_INT > 22) {
            moreView = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.xrefreshview_footer_6, this);
        } else {
            moreView = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.xrefreshview_footer, this);
        }*/
        if (android.os.Build.VERSION.SDK_INT > 22) {
            mContent = (ViewGroup) LayoutInflater.from(context).inflate(
                    R.layout.xrefreshview_header_6, this);
        } else {
            mContent = (ViewGroup) LayoutInflater.from(context).inflate(
